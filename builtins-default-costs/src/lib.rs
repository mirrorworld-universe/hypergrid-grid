...
lazy_static! {
    ...
    pub static ref BUILTIN_INSTRUCTION_COSTS: AHashMap<Pubkey, u64> = [
        ...
        (solana_sdk::sonic_account_migrater::program::id(), sonic_account_migrater_program::processor::DEFAULT_COMPUTE_UNITS),
        (solana_sdk::sonic_fee_settlement::program::id(), sonic_fee_settlement_program::processor::DEFAULT_COMPUTE_UNITS),
    ]
    .iter()
    .cloned()
    .collect();
